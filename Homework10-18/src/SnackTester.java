...
Write a method isHealthier which returns true if this Snack has fewer grams of fat than the parameter Snack.

Include toString and equals.

Snack should implement Comparable interface. Snacks are ordered first by gramsOfFat with the Snack with the fewer grams of fat coming first. 
If the grams of fat are the same order by price with the lowest price coming first, If prices are also equal, order alphabetically by description
...
public class SnackTester
{
   ...
   {     
      ...
      //test is subclass
      Product13 testing = apple; //warning okay
